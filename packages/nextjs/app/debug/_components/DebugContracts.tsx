...
export function DebugContracts() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto py-8 px-4">
      <div className="bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-blue-900 shadow-2xl rounded-3xl w-full p-8 border border-slate-200 dark:border-blue-500/30 backdrop-blur-sm">
        <div className="flex items-center justify-center mb-8">
          <div className="bg-slate-100/80 dark:bg-blue-500/10 backdrop-blur-md px-6 py-3 rounded-full border border-slate-200 dark:border-blue-500/20 shadow-lg">
            <h1 className="text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-blue-600 dark:from-cyan-400 dark:to-blue-500">
              {nftName}
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-slate-100/80 dark:bg-blue-900/40 rounded-2xl px-8 py-6 shadow-xl border border-slate-200 dark:border-blue-500/20 backdrop-blur-md text-center">
            ...
            <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-blue-600 dark:from-purple-400 dark:via-pink-400 dark:to-blue-400">
              {balance !== null ? (
                balance
              ) : (
                <div className="flex items-center justify-center">
                  <div className="h-8 w-8 border-t-2 border-b-2 border-indigo-500 dark:border-blue-400 rounded-full animate-spin"></div>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-8">
              ...
              className={`relative overflow-hidden btn border-0 shadow-xl px-8 py-3 rounded-xl font-semibold text-lg 
                ${
                  isOperationDisabled("mint")
                    ...
                    : "bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 dark:from-blue-600 dark:to-cyan-500 dark:hover:from-blue-500 dark:hover:to-cyan-400 text-white transform hover:scale-105 transition-all duration-300"
                }`}
              onClick={mintNFT}
          ...
          <div className="bg-slate-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-slate-200 dark:border-blue-500/20 backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
              <input
                ...
                className="input bg-white/70 dark:bg-blue-900/30 border border-slate-300 dark:border-blue-500/30 focus:border-indigo-400 dark:focus:border-blue-400 focus:bg-white dark:focus:bg-blue-900/40 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-blue-300/50 w-full sm:w-96 rounded-xl"
                placeholder="Enter recipient address"
                disabled={txStatus.status === "pending"}
              />
              <button
                className={`relative btn border-0 shadow-lg px-6 rounded-xl font-semibold 
                  ${
                    isOperationDisabled("mintTo")
                      ? "bg-slate-200 text-slate-400 dark:bg-green-900/50 dark:text-green-300/70 cursor-not-allowed"
                      : "bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 dark:from-green-600 dark:to-emerald-500 dark:hover:from-green-500 dark:hover:to-emerald-400 text-white transform hover:scale-105 transition-all duration-300"
                  }`}
          ...
          <div className="bg-slate-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-slate-200 dark:border-blue-500/20 backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
              <input
                ...
                className="input bg-white/70 dark:bg-blue-900/30 border border-slate-300 dark:border-blue-500/30 focus:border-indigo-400 dark:focus:border-blue-400 focus:bg-white dark:focus:bg-blue-900/40 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-blue-300/50 w-full sm:w-48 rounded-xl"
                  ...
                  className={`btn border-0 shadow-lg px-4 rounded-xl font-semibold 
                    ${
                      isOperationDisabled("checkOwner")
                        ...
                        : "bg-gradient-to-r from-violet-500 to-indigo-600 hover:from-violet-600 hover:to-indigo-700 dark:from-purple-600 dark:to-indigo-500 dark:hover:from-purple-500 dark:hover:to-indigo-400 text-white transform hover:scale-105 transition-all duration-300"
                    }`}
                  onClick={checkOwner}
                  ...
                  className={`btn border-0 shadow-lg px-4 rounded-xl font-semibold 
                    ${
                      isOperationDisabled("burn")
                        ...
                        : "bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-600 hover:to-red-700 dark:from-red-600 dark:to-pink-500 dark:hover:from-red-500 dark:hover:to-pink-400 text-white transform hover:scale-105 transition-all duration-300"
                    }`}
                  onClick={burnToken}
